...
const BUILD='2026-09-02-mmw-master-v18-visual-fixed';
app.disable('x-powered-by');
app.use((req,res,next)=>{res.set('Cache-Control','no-store,no-cache,must-revalidate,proxy-revalidate');res.set('Pragma','no-cache');res.set('Expires','0');res.set('X-MMW-Build',BUILD);res.set('X-MMW-Repo','itimchenko00-hash/MMW_COMPANY');res.set('X-MMW-Projects','consolidated-under-projects');res.set('X-MMW-International','global-platform');next()});
...
app.get('/',(req,res)=>sendHtml(path.join(PUBLIC,'home-v11.html'),res));
app.get('/index.html',(req,res)=>sendHtml(path.join(PUBLIC,'home-v11.html'),res));
...
const aliases={
'/aladin':'projects/ALADIN/website/aladin.html','/aladin-v2':'projects/ALADIN/website/aladin-v2.html','/nexus':'projects/NEXUS-WORK/website/nexus.html','/nexus-logistics':'projects/NEXUS-LOGISTICS/website/nexus-logistics-v2.html','/nexus-logistics-v2':'projects/NEXUS-LOGISTICS/website/nexus-logistics-v2.html','/carpathia':'projects/CARPATHIA/website/carpathia.html','/carpathia-master':'projects/CARPATHIA/website/carpathia-eco-lodge-master-v2.html','/carpathia-feasibility':'projects/CARPATHIA/website/carpathia-feasibility.html','/agrohub':'projects/AGROHUB/website/agrohub.html','/energy':'projects/ENERGY-PARK/website/energy-master-v1.html','/energy-master':'projects/ENERGY-PARK/website/energy-master-v1.html'};
...
app.get('/health',(req,res)=>res.json({service:'MMW-COMPANY',status:'ok',build:BUILD,repo:'itimchenko00-hash/MMW_COMPANY',branch:'main',visualLayer:'enabled-on-project-html',international:'/international',presentations:'/project-presentation-hub.html',order:'https://mmw-order.onrender.com'}));
